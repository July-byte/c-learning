...
bool ProcessChoice(int choice)
{
  ...
  switch (choice)
  {
    ...
    case 0:
      return true;
    default:
      Console.WriteLine("Выбор некорректный. Введите число в соответствии с пунктами меню!");
      break;
  }
  return false;
}
...
{
  if (firstNumber < 0)
    throw new ArgumentExeption("Невозможно вычислить корень квадратный из отрицательного числа");
